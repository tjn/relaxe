...
public class ReferenceKeyIdentityMap<	
...
>
	extends AbstractIdentityMap<A, R, T, E, H, M, RE>
{
	private K key;
	
	public ReferenceKeyIdentityMap(K key) {
		super();
	...
	@Override
	protected RE getIdentityKey(E src) throws EntityRuntimeException {
		RH rh = this.key.get(src);
