...
public interface HasLong<
	...
	R extends HasLong.Read<A, R, W>,
	W extends HasLong.Write<A, R, W>
>
{	
	R asRead();	
	W asWrite();	
	...
	>
		 ...
		 */
		LongHolder getLong(LongAttribute<A, R, W> key);		
	}
	...
	> extends HasLong<A, R, W> {
		 ...
		 * @throws NullPointerException If <code>key</code> is <code>null</code>.
		 */
		void setLong(LongAttribute<A, R, W> key, LongHolder newValue);
	}
}
