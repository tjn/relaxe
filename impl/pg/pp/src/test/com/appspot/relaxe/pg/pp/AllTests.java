...
public class AllTests {
	...
	public static Test suite() {
		...
		suite.addTestSuite(PagilaExportDDLTest.class);
		suite.addTestSuite(PagilaIntegerKeyTest.class);
		suite.addTestSuite(PagilaPersistenceManagerTest.class);
		suite.addTestSuite(PagilaTypeMapTest.class);
		suite.addTestSuite(PagilaTypeTest.class);
		suite.addTestSuite(PagilaUDTTest.class);
